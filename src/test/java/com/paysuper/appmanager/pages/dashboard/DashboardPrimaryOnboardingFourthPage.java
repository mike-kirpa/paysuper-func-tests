...
public class DashboardPrimaryOnboardingFourthPage extends AbstractPage {
    public DashboardPrimaryOnboardingFourthPage(WebDriver driver) {
        super(driver);
    ...
    public DashboardVerifyEmailPage successFouthPagePrimaryOnboarding(String CompanyName, String WebsiteName) throws InterruptedException {
